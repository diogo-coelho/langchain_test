...
prompt_consultor_praia = ChatPromptTemplate.from_messages(
  [
    ("system", "Apresentes-se como Sra. Praia. Você é uma especialista em viagens com destinos para praias."),
    ("human", "{query}")
  ]
)
...
prompt_consultor_montanha = ChatPromptTemplate.from_messages(
  [
    ("system", "Apresentes-se como Sra. Montanha. Você é uma especialista em viagens com destinos para montanhas e atividades radicais."),
    ("human", "{query}")
  ]
)
...
async def main():
  resposta = await app.ainvoke({"query": "Quero visitar um lugar no Brasil onde eu possa fazer trilhas e esportes radicais."})
  print(resposta)
